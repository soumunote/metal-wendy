...
```
                                         ...
                                         ┃I2C1 SCL  GPIO 3  ┃ 5┃ 6┃GND               ┃ board GND 
                                         ┃          GPIO 4  ┃ 7┃ 6┃UARTO TX          ┃  
                                         ┃          GND     ┃ 9┃10┃UARTO RX          ┃  
                                         ┃          GPIO 17 ┃11┃12┃GPIO 18           ┃ Left Wing (earlobe) Servo plus(orange)
                                         ┃          GPIO 27 ┃13┃14┃GND               ┃  
                                         ...
                                         ┃          GPIO 13 ┃33┃34┃GND               ┃  
 Right Wing (earlobe) Servo plus(orange) ┃SPI1 MISO GPIO 19 ┃35┃36┃GPIO 16  SPI1 CS0 ┃  
